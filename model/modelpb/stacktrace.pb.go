...
type StacktraceFrame struct {
	...
	Colno               *int32           `protobuf:"varint,3,opt,name=colno,proto3,oneof" json:"colno,omitempty"`
...
func (x *StacktraceFrame) GetLineno() int32 {
...
func (x *StacktraceFrame) GetColno() int32 {
...
type Original struct {
	...
	Lineno       *int32 `protobuf:"varint,4,opt,name=lineno,proto3,oneof" json:"lineno,omitempty"`
	Colno        *int32 `protobuf:"varint,5,opt,name=colno,proto3,oneof" json:"colno,omitempty"`
...
func (x *Original) GetLineno() int32 {
	if x != nil && x.Lineno != nil {
		return *x.Lineno
	}
	return 0
...
func (x *Original) GetColno() int32 {
	if x != nil && x.Colno != nil {
		return *x.Colno
	}
	return 0
...
var file_stacktrace_proto_rawDesc = []byte{
	...
	0x05, 0x48, 0x00, 0x52, 0x06, 0x6c, 0x69, 0x6e, 0x65, 0x6e, 0x6f, 0x88, 0x01, 0x01, 0x12, 0x19,
	0x0a, 0x05, 0x63, 0x6f, 0x6c, 0x6e, 0x6f, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x48, 0x01, 0x52,
	...
	0x04, 0x20, 0x01, 0x28, 0x05, 0x48, 0x00, 0x52, 0x06, 0x6c, 0x69, 0x6e, 0x65, 0x6e, 0x6f, 0x88,
	0x01, 0x01, 0x12, 0x19, 0x0a, 0x05, 0x63, 0x6f, 0x6c, 0x6e, 0x6f, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x05, 0x48, 0x01, 0x52, 0x05, 0x63, 0x6f, 0x6c, 0x6e, 0x6f, 0x88, 0x01, 0x01, 0x12, 0x1a, 0x0a,
