...
type IP struct {
	...
	//	*IP_V4
	//	*IP_V6
	IpAddr isIP_IpAddr `protobuf_oneof:"ip_addr"`
}
...
func (m *IP) GetIpAddr() isIP_IpAddr {
	if m != nil {
		return m.IpAddr
	}
	return nil
...
func (x *IP) GetV6() []byte {
	if x, ok := x.GetIpAddr().(*IP_V6); ok {
		return x.V6
	}
	return nil
}

type isIP_IpAddr interface {
	isIP_IpAddr()
}
...
func (*IP_V4) isIP_IpAddr() {}

func (*IP_V6) isIP_IpAddr() {}

var File_ip_proto protoreflect.FileDescriptor

var file_ip_proto_rawDesc = []byte{
	0x0a, 0x08, 0x69, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x65, 0x6c, 0x61, 0x73,
	0x74, 0x69, 0x63, 0x2e, 0x61, 0x70, 0x6d, 0x2e, 0x76, 0x31, 0x22, 0x33, 0x0a, 0x02, 0x49, 0x50,
	0x12, 0x10, 0x0a, 0x02, 0x76, 0x34, 0x18, 0x01, 0x20, 0x01, 0x28, 0x07, 0x48, 0x00, 0x52, 0x02,
	0x76, 0x34, 0x12, 0x10, 0x0a, 0x02, 0x76, 0x36, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x48, 0x00,
	0x52, 0x02, 0x76, 0x36, 0x42, 0x09, 0x0a, 0x07, 0x69, 0x70, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x42,
...
func file_ip_proto_init() {
	...
	file_ip_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*IP_V4)(nil),
		(*IP_V6)(nil),
	}
	type x struct{}
