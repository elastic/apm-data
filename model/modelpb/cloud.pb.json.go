...
func (c *Cloud) toModelJSON(out *modeljson.Cloud) {
	out.AvailabilityZone = c.AvailabilityZone
	out.Provider = c.Provider
	out.Region = c.Region
	out.Account = modeljson.CloudAccount{
		ID:   c.AccountId,
		Name: c.AccountName,
	}
	out.Service = modeljson.CloudService{
		Name: c.ServiceName,
	}
	out.Project = modeljson.CloudProject{
		ID:   c.ProjectId,
		Name: c.ProjectName,
	}
	out.Instance = modeljson.CloudInstance{
		ID:   c.InstanceId,
		Name: c.InstanceName,
	}
	out.Machine = modeljson.CloudMachine{
		Type: c.MachineType,
	}
	if c.Origin != nil {
