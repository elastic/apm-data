...
type APMBatch struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Events []*APMEvent `protobuf:"bytes,1,rep,name=events,proto3" json:"events,omitempty"`
}

func (x *APMBatch) Reset() {
	*x = APMBatch{}
...
func (x *APMBatch) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*APMBatch) ProtoMessage() {}

func (x *APMBatch) ProtoReflect() protoreflect.Message {
	mi := &file_batch_proto_msgTypes[0]
...
// Deprecated: Use APMBatch.ProtoReflect.Descriptor instead.
func (*APMBatch) Descriptor() ([]byte, []int) {
	return file_batch_proto_rawDescGZIP(), []int{0}
}

func (x *APMBatch) GetEvents() []*APMEvent {
	if x != nil {
		return x.Events
	}
	return nil
...
var file_batch_proto_rawDesc = []byte{
	0x0a, 0x0b, 0x62, 0x61, 0x74, 0x63, 0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x65,
	0x6c, 0x61, 0x73, 0x74, 0x69, 0x63, 0x2e, 0x61, 0x70, 0x6d, 0x2e, 0x76, 0x31, 0x1a, 0x0e, 0x61,
	0x70, 0x6d, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x3c, 0x0a,
	0x08, 0x41, 0x50, 0x4d, 0x42, 0x61, 0x74, 0x63, 0x68, 0x12, 0x30, 0x0a, 0x06, 0x65, 0x76, 0x65,
	0x6e, 0x74, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x65, 0x6c, 0x61, 0x73,
	0x74, 0x69, 0x63, 0x2e, 0x61, 0x70, 0x6d, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x50, 0x4d, 0x45, 0x76,
	0x65, 0x6e, 0x74, 0x52, 0x06, 0x65, 0x76, 0x65, 0x6e, 0x74, 0x73, 0x42, 0x2b, 0x5a, 0x29, 0x67,
...
var file_batch_proto_goTypes = []interface{}{
	(*APMBatch)(nil), // 0: elastic.apm.v1.APMBatch
	(*APMEvent)(nil), // 1: elastic.apm.v1.APMEvent
}
var file_batch_proto_depIdxs = []int32{
	1, // 0: elastic.apm.v1.APMBatch.events:type_name -> elastic.apm.v1.APMEvent
